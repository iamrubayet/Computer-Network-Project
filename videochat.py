...
receiver = StreamingServer(local_ip_address,8888)
...
window.title("Video Call App v0.0.0.1")
...
btn_camera = tk.Button(window,text="start camera screen",width=50,command=start_camera_stream)
